...
<body>
  ...
  <?php
    ...
    $sql_img = "SELECT picture, pic_products.id_pictures FROM pic_products, product WHERE product.id_pictures = pic_products.id_pictures order by pic_products.id_pictures";
    ...
    if ($result->num_rows > 0) {
      while ($row = $result->fetch_assoc()) {
        ...
        echo '<a href="page_product.php?id_product=' . $row["id_product"] . '" class="more-details">				<button class="button">
					<span>Подробнее</span>
					<div class="cart">
